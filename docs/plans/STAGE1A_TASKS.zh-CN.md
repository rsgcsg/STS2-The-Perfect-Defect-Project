...
| 4 / 07、08 | 首个逻辑页从原生事实→完整菜单→真实投递→记录核验→研究投影贯通；先单页多选，再跨组和牌堆 | 依赖3；source/package与精确原生/Human分开 |
...
新01设计参考为[ADR-0015候选d478e702](https://github.com/rsgcsg/STS2-The-Perfect-Defect-Project/blob/d478e70255f9e68b56df3741a781fc03a3ceba14/docs/adr/0015-native-logical-interaction.md)。
